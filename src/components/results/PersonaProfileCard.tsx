...
export default function PersonaProfileCard({ persona }: PersonaProfileCardProps) {
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {(persona.roleModel || []).map((model, index) => {
            ...
            {(!persona.roleModel || persona.roleModel.length === 0) && (
